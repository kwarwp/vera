...
boia4 = Elemento(BOIA, cena=ilhamar, x=320, y=450, w=100)
boia5 = Elemento(BOIA, cena=ilhamar, x=440, y=550, w=100)
boia6 = Elemento(BOIA, cena=ilhamar, x=550, y=80, w=100)
boia7 = Elemento(BOIA, cena=ilhamar, x=700, y=200, w=100)
boia8 = Elemento(BOIA, cena=ilhamar, x=850, y=300, w=100)
boia9 = Elemento(BOIA, cena=ilhamar, x=1000, y=400, w=100)
boia10 = Elemento(BOIA, cena=ilhamar, x=1150, y=500, w=100)