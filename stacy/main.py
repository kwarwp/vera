...
class Terra:
    def __init__(self, universo):
        ...
        """
        self.terra = Elemento(TERRA, x=800, y=180, w=320, h=280, vai=self.pega)
        self.longe = Cena()
        self.na_mao = False
...
class Foguete:
    def __init__(self, universo, left="300px", top="300px"):
        self.universo = universo
        self.foguete = Elemento(FOGUETE, style=dict(left=left, top=top, width="600px", height="200px"), vai=self.pega)
        self.longe = Cena()
        self.na_mao = False
...
class Estacao:
    def __init__(self, universo, left="300px", top="300px", icone=PESSOA, ITENS=[]):
        ...
        self.usar = Texto(self.universo, FACA_USA)
        """
        self.estacao = Elemento(ESTACAO, x=left, y=top, w=320, h=280, vai=self.pega)
...
class Universo:
    def __init__(self):
        ...
        estacao = Estacao(self.universo, left="100px", top="100px", icone=PESSOA)
        estacao2 = Estacao(self.universo, left="50px", top="200px", icone=ANIMAL)
