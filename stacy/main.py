...
class Foguete:
    def __init__(self, universo, left="300px", top="300px"):
        self.universo = universo
        self.foguete = Elemento(FOGUETE, style=dict(left=left, top=top, width="800px", height="200px"), vai=self.pega)
        self.longe = Cena()
        self.na_mao = False
...
class Universo:
    def __init__(self):
        ...
        estacao2 = Estacao(self.universo, left="150px", top="200px", icone=ANIMAL)
