...
class Terra:
    def __init__(self, universo):
        ...
        """
        self.terra = Elemento(TERRA, style=dict(left="100px", width="250px", Top="800px"), vai=self.pega)
        self.longe = Cena()
        self.na_mao = False
...
class Universo:
    def __init__(self):
        ...
        estacao2 = Estacao(self.universo, left="250px", top="200px", icone=ANIMAL)
        estacao3 = Estacao(self.universo, left="350px", top="100px", icone=OBJETO)
