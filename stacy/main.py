...
class Terra:
    def __init__(self, universo):
        ...
        """
        self.terra = Elemento(TERRA, style=dict(left="100px", width="80px"), vai=self.pega)
        self.longe = Cena()
        self.na_mao = False
...
class Foguete:
    def __init__(self, universo, left="300px", top="300px"):
        self.universo = universo
        self.foguete = Elemento(FOGUETE, style=dict(left=left, top=top, width="200px", height="250px"), vai=self.pega)
        self.longe = Cena()
        self.na_mao = False
