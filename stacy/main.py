...
class Menudeanimais:
    def __init__(self, universo, left=200, top=50):
        ...
        self.menudeanimais = Elemento(MENUDEANIMAIS[0], x=left, y=top, w=80, h=80, vai=self.pega, cena=u)
        self.menudeanimais = Elemento(MENUDEANIMAIS[1], x=left -20, y=top +20, w=80, h=80, vai=self.pega, cena=u)
        self.menudeanimais = Elemento(MENUDEANIMAIS[2], x=left,-40 y=top +40, w=80, h=80, vai=self.pega, cena=u)
        self.menudeanimais = Elemento(MENUDEANIMAIS[3], x=left -60, y=top, w=80, h=80, vai=self.pega, cena=u)
        self.longe = Cena()
        self.na_mao = False
