...
class Esportes:  
    def __init__(self, parque,tit="bola", imagem=BOLA, x=100, y=200): 
        peteca = Elemento(imagem, tit=tit, x=x, y=y, w=40, h=40)
        peteca.entra(parque)
        #bola = Elemento(BOLA, x=100, y=200, w=80, h=60)
        #bola.entra(parque)
        
class Bicho:
    def __init__(self, parque, tit="coelho", imagem=COELHO, x=100, y=300):
...
class Conjuntos:
    def __init__(self):
        ...
        Esportes(parque, tit="peteca", imagem=PETECA, x=400, y=200) 
